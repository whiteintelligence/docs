...
description: Connect databases, data warehouses, and SaaS tools to Analytics, then authenticate the source and configure sync frequency for ongoing imports.
---
