...
description: Go from empty workspace to a live Analytics dashboard by connecting a data source, creating a dashboard, adding a chart, and sharing the result.
---
