...
description: Connect your first integration from the connector catalog by authenticating with the external tool, mapping fields, and testing the connection.
---
