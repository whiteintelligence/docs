...
description: Register an HTTPS webhook endpoint, subscribe to event types, and verify the HMAC-SHA256 signature header to receive workspace events securely.
---
...
<Steps>
  ...
  <Step title="Select events">
    ...
    The full list of available event types and their payload schemas is shown in the event picker.
  </Step>
