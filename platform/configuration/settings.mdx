...
description: Configure workspace name, slug, timezone, language, session timeouts, and IP allowlist settings that apply by default to every member of your workspace.
---
