---
title: Key concepts
description: Learn the four foundational concepts—workspaces, projects, members and roles, and API credentials—that underpin every workflow on the platform.
---
